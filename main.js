...
var to_be_drawn = quick_draw_data_set[random_no]
document.getElementById("to_be_drawn").innerHTML = "sketch to be drawn : " + to_be_drawn;
var timer_count = 0
var timer_check = ""
var drawn_sketch = ""
var answer_holder = ""
...
function updateCanvas()
{
    ...
    array = quick_draw_data_set[random_number];
    sketch = array;
    document.getElementById("to_be_drawn").innerHTML = "sketch_to_be_drawn : " + sketch;
}
...
function check_sketch()
{
    ...
    if (timer_count>40000000){timer_count = 0;
        timer_check = "completed";
        document.getElementById("to_be_drawn").innerHTML = "Your Sketch"
...
function gotResult(error, results)
{
    ...
    console.log(results);
    document.getElementById('guessed_sketch').innerHTML = 'Label :  ' + results[0].label;
